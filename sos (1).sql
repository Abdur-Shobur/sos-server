...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2023 at 10:29 AM
...
CREATE TABLE `carts` (
  ...
  `vendor_id` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
  ...
  `tags` varchar(191) DEFAULT NULL,
  `commision_type` varchar(191) DEFAULT NULL,
...
INSERT INTO `products` (`id`, `category_id`, `subcategory_id`, `brand_id`, `user_id`, `slug`, `name`, `short_description`, `long_description`, `selling_price`, `original_price`, `qty`, `image`, `status`, `meta_title`, `meta_keyword`, `meta_description`, `product_color`, `product_size`, `tags`, `commision_type`, `request`, `user_type`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 34, NULL, NULL, 2, 'vendor-pro', 'vendor pro', 'asdfsdf', 'fsfsaf', '234', '234', '2342', 'uploads/product/1678094279.jpg', 'active', 'asdfasf', 'asdfasdf', 'asdfsdfs', NULL, NULL, 'asdf,sdfsf', NULL, NULL, NULL, '2023-03-06 03:17:59', '2023-03-06 03:17:59', NULL),
(2, 2, NULL, NULL, 2, 'new', 'new', 'asdfasf', 'fdsdf', '234', '4234', '234', 'uploads/product/1678189293.png', 'active', 'asdf', 'sdfs', 'sadf', NULL, NULL, 'sdfs,sdfsdf,sdfsf', NULL, NULL, NULL, '2023-03-07 05:41:33', '2023-03-07 05:41:33', NULL);
...
CREATE TABLE `users` (
  ...
  `role_as` varchar(191) DEFAULT NULL,
  `image` varchar(191) DEFAULT NULL,
